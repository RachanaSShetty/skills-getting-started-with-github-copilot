...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice drills, scrimmages, and local tournaments",
    ...
    "Debate Team": {
        "description": "Practice formal debating, public speaking, and competitions",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Validate student is registered for the activity
